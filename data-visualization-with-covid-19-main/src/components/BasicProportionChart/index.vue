  ...
  methods: {
    ...
    setOptions() {
      let list = [
        {
          name: '现有确诊',
          value: calculateProportion(this.data.chinaTotal.nowConfirm, this.data.chinaTotal.confirm)
        },
        {
          name: '境外输入',
          value: calculateProportion(this.data.chinaTotal.importedCase, this.data.chinaTotal.confirm)
        },
        {
          name: '累计治愈',
          value: calculateProportion(this.data.chinaTotal.heal, this.data.chinaTotal.confirm)
        }
      ]
